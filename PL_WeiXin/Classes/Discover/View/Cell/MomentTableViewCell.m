...
@property (nonatomic, strong) PhotosCollectionViewController *photosController;

@property (nonatomic, strong) UILabel *timeLabel;

@property (nonatomic, strong) UIImageView *likeCommentLogoView;

@property (nonatomic, strong) UIImageView *commentsBubbleView;

@property (nonatomic, strong) CommentTableViewController *commentsController;
