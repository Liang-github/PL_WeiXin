...
- (void)setAvatar:(UIImage *)avatar {
    ...
    self.avatarImageView = [[UIImageView alloc] initWithFrame:CGRectMake(kContentInsetH, kContentInsetV, size, size)];
...
- (void)setName:(NSString *)name {
    ...
    CGFloat marginY = self.style == ContactsTableViewCellStyleSubtitle ? kContentInsetV + 5 : 0;
    self.nameLabel = [[UILabel alloc] initWithFrame:CGRectMake(marginX, marginY, self.bounds.size.width - marginX, self.bounds.size.height)];
...
- (void)setDescriptionText:(NSString *)descriptionText {
    ...
    self.descriptionLabel = [[UILabel alloc] initWithFrame:CGRectMake(marginX, marginY, self.bounds.size.width - marginX, 20)];
